						...
						<div id="content_2" class="content">
							...
							<form  action="" method="post" enctype="multipart/form-data">
								<table width="220" height="106" border="0">
									...
									<tr>
										<td align="center"><input name="pourcentage" type="text" style="width:100%" placeholder="Percentage" required="required" /></td>
									</tr>
									<tr>
											...
											<div class="panel panel-default">
												<div class="panel-body">
                                                    <form action="" method="post" enctype="multipart/form-data" >
														...
														<div class="form-group"> 
															<label class="col-sm-3 col-md-4 control-label">Percentage</label>
															<div class="col-sm-8">
