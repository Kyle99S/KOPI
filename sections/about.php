<section class="about" id="about">
    ...
    <div class="about-info">
        <div class="image" data-aos="fade-right">
            <img src="./images/coffee/Cappucino.jpg" alt="">
        </div>

        <div class="content" data-aos="fade-left">
            <h3>best tasty beverages in metro manila</h3>
            <p>Our team is on a mission to create create tasting and nutritious juices, smoothies, bowls and bites and most importanly Coffee. Our menu is full of fresh offers that are eqully craveable and  guilt-free. We take a lot of pride in serving products that are hight in nutritional value.</p>
            <p>Our coffee beverages are freshly prepared upon order, using high-quality coffee beans and natural ingredients, without artificial flavors or additives.</p>
    ...
    <h1 class="heading" data-aos="fade-up"> Our Awesome Team! </h1>
